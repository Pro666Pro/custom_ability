game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Credits",Text = "By Nexer1234" ,Duration = 10, Icon = "rbxthumb://type=Asset&id=9649923610&w=150&h=150",Button1 = "alright dud"})
