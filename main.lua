...
function addBody(body)
	body:WaitForChild('HumanoidRootPart').Touched:connect(function(hit)
      ...
      _G.SonicMode = false
      _G.SlapAura = false
      game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Error",Text = "Sonic Mode Turned Off",Icon = "rbxassetid://7733658504",Duration = 5})
		end
	end)
end
...
TextButton_4.Text = "Explosive Stomp"
...
_G.SonicMode = true
_G.SlapAura = true
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Error",Text = "Sonic Mode Turned On",Icon = "rbxassetid://7733658504",Duration = 5})
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Credits",Text = "Copied YT Channel Link" ,Duration = 1000, Icon = "rbxthumb://type=Asset&id=9649923610&w=150&h=150",Button1 = "OK"})
